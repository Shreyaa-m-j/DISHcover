...
<body>
        ...
        <div class="tagAndSearch">
            ...
            <div class="container">
                ...
                <div id="searchByDish" style="display: none;">
                    <!-- Dish search form -->
                    <form action="/searchByDish" method="GET">
                        <label for="dish">Search by Dish Name:</label>
    ...
    <section id="upload">
        ...
        <div class="uploadDiv">
            ...
            <button type="button" class="uploadbutton btn btn-lg searchButton">Upload it here</button>
        </div>
    </section>
        ...
        <div class="container px-4 py-5" id="hanging-icons">
            ...
            <div class="row g-4 py-5 row-cols-1 row-cols-lg-3">
                ...
                <div class="col d-flex align-items-start">
                    ...
                    <div>
                        <h3 class="fs-2">Rate and Review the recipes</h3>
                        <p>Users are also provided with an option to rate the recipes based on their experience.</p>
                    </div>
                </div>
            </div>
        </div>
